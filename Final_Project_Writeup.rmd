...
\begin{equation*}
\begin{gathered}
\pi(\beta_{0}, \beta_{1}, \beta_{2}, \beta_{3}| y_{1},...,y_{j}, n_{1},...,n_{j}) \propto \pi(\beta_{0}, \beta_{1}, \beta_{2}, \beta_{3}) \times L(\beta_{0}, \beta_{1}, \beta_{2}, \beta_{3} |  y_{1},...,y_{j}, n_{1},...,n_{j})\\
\pi(\beta_{0}, \beta_{1}, \beta_{2}, \beta_{3}) = \pi(\beta_{0})\pi(\beta_{1})\pi(\beta_{2})\pi(\beta_{3})
\end{gathered}
\end{equation*}
...
&\propto \pi(\mu_{j}, \eta_{j}) \times L (p_{j}| y_{1},...,y_{j})\\
&\propto \pi(\mu_{j}, \eta_{j}) \times L (\beta_{0}, \beta_{1}, \beta_{3} | y_{1},...,y_{j}, n_{1},..., n_{j})\\
